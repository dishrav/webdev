...
const quizArray = [
    {
        id: "0",
        question: "What is the name given to those applications that combine text, sound, graphics, motion, video?",
        options: ["Multimedia", "Maxomedia", "Motionware", "Anigraphics"],
        correct: "Multimedia",
    },
    {
        id: "1",
        question: "Which of the following is a system software?",
        options: ["Microsoft Word", "Adobe Photoshop", "Microsoft Powerpoint", "Windows 7"],
        correct: "Windows 7",
    },
    {
        id: "2",
        question: "Which of the following is an application software",
        options: ["LINUX", "macOS", "UNIX", "Graphics"],
        correct: "Graphics",
    },
    {
        id: "3",
    ...
    },
    {
        ...
        options: [".tmp", ".txt", ".tnt", ".tar"],
        correct: ".tmp",
    },
    {
        id: "5",
        question: "Programming language Java is developed by ___ ",
        options: ["Paul Allen", "Jaap Haartsen", "Charles Simonyi", "James Gosling"],
